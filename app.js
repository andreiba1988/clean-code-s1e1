...
var taskInput=document.querySelector(".data__input");//ddd a new task.
var addButton=document.querySelector(".data__btn");//first button
var incompleteTaskHolder=document.querySelector(".todo");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".create");//completed-tasks
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("list_mode");
    ...
    listItem.classList.toggle("list_mode");
};
